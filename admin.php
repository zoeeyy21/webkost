    ...
    <nav class="navbar" style="position: fixed;">
        <div class="navbar-container">
            ...
            <ul class="menu-items " style="margin-left: 24em">
                ...
                <li><a href="#pemesanan">Order</a></li>
            </ul>
                    ...
                    <div class="card shadow" style="width: 18rem;">
                        ...
                        <div class="card-body" style="background-color: #F5F5F5;">
                            ...
                            <div class="harga mt-4 d-flex">
                                ...
                                <div class="harga mt-4 d-flex">
                                    <a href="edit.php?id_produk=<?php echo $data['id_produk']; ?>"><button
                                            class="booking"><i data-feather="edit"></i></button></a>
                                    <a href="proses/hapus.php?id_produk=<?php echo $data['id_produk']; ?>"><button
                                            class="booking"><i data-feather="trash-2"></i></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-3 d-flex justify-content-center mb-5">
                <div class="card shadow" style="width: 18rem;">
                    <div class="card-body"
                        ...
                        <a href="tambahadmin.php"><button><i data-feather="plus"
                                    style="color: #004577;width: 70px; height: 70px;"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td><a href="proses/hapus_pesanan.php?id=<?php echo $data['id']; ?>"><i data-feather="trash-2"
                                    style="color: #004577;"></i></a></td>
                    </tr>
                    <?php
                    $no++;
                }
